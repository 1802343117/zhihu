					...
					<div class="Topstory-mainColumnCard">
						...
						<div class="tjkp" v-for="(item, index) in recommenedList" :key="index">
							...
							<div class="kpnr">
								...
								<div class="gnaj">
									<span>
										<button aria-label="赞同 1.4K" type="button" class="Buttonup" onmousemove="this.className='Buttonup_xf'"onmouseout="this.className='Buttonup'">
										...
										<button aria-label="反对" type="button" class="Buttondown" onmousemove="this.className='Buttondown_xf'"onmouseout="this.className='Buttondown'">
											<span style="display: inline-flex; align-items: center;">
									...
									<button type="button" class="ButtonwithLabel" onmousemove="this.className='ButtonwithLabel_xf'"onmouseout="this.className='ButtonwithLabel'">
										<span style="display: inline-flex; align-items: center;">​
				...
				<div class="GlobalSidebar">
					...
					<div class="gndht">
						<div class="col-4" style="width: 60px;height: 94px;background-color: #FFFFFF;cursor: pointer;fill: #ffcf00;">
							<svg style="color: #8590a6;margin-bottom: 6px;margin-top: 20px;margin-left: 35px;" viewBox="0 0 24 24" width="24" height="24">
						...
						<div class="col-4" style="width: 60px;height: 94px;background-color: #FFFFFF;cursor: pointer;fill: #0f88eb;">
							<svg style="color: #8590a6;margin-bottom: 6px;margin-top: 25px;margin-left: 40px;" viewBox="0 0 24 24" width="20" height="20">
...
<style lang="scss" scoped>
	...
	.Buttondown_xf {
		...
		padding: 0 12px;
		color: #0084ff;
		background: rgba(217, 237, 255, 25);
		border-color: transparent;
		font-size: 14px;
		text-align: center;
		cursor: pointer;
